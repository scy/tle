...
BLOG_AUTHOR = "Tim Weber"  # (translatable)
BLOG_TITLE = "Tim Lives Everywhere"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://timliv.es/everywhere/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "https://timliv.es/"
BLOG_EMAIL = "mail@timliv.es"
BLOG_DESCRIPTION = {"en": "Keep on moving.", "de": "Bleib in Bewegung."}  # (translatable)
...
POSTS = (
    ("everywhere/*.md",   "everywhere", "post.tmpl"),
    ("everywhere/*.rst",  "everywhere", "post.tmpl"),
    ("everywhere/*.txt",  "everywhere", "post.tmpl"),
...
ARCHIVE_PATH = "everywhere/archive"
...
# (translatable)
LICENSE = """
<a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/"><img alt="Creative Commons License" style="border-width:0" src="https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png" /></a><br /><span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">Tim Lives Everywhere</span> by <a xmlns:cc="http://creativecommons.org/ns#" href="https://timliv.es/everywhere/" property="cc:attributionName" rel="cc:attributionURL">Tim Weber</a> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a>.
"""
